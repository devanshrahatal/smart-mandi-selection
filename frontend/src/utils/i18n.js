...
export const TRANSLATIONS = {
  en: {
    ...
    storageTab: "Storage & Cold Chain",
    ordersTab: "Escrow & Orders",
    poolingTab: "Kisan Pool",
    grievanceTab: "Grievance Portal",
  ...
  hi: {
    ...
    mapTab: "मुनाफा नक्शा",
    marketplaceTab: "मार्केटप्लेस / खरीदार",
    storageTab: "कोल्ड स्टोरेज व वेयरहाउस",
    ordersTab: "एस्क्रो व रसीदें",
    poolingTab: "किसान पूल (साझा गाड़ी)",
    grievanceTab: "शिकायत व निवारण",
  ...
  mr: {
    ...
    mapTab: "नफा नकाशा",
    marketplaceTab: "मार्केटप्लेस / खरेदीदार",
    storageTab: "कोल्ड स्टोरेज व वखार",
    ordersTab: "एस्क्रो व पावती",
    poolingTab: "किसान पूल (एकत्रित वाहतूक)",
    grievanceTab: "तक्रार निवारण पोर्टल",
  ...
  gu: {
    ...
    mapTab: "નફાનો નકશો",
    marketplaceTab: "માર્કેટપ્લેસ / ખરીદદાર",
    storageTab: "કોલ્ડ સ્ટોરેજ અને વેરહાઉસ",
    ordersTab: "એસ્ક્રો અને રસીદ",
    poolingTab: "કિસાન પૂલ (શેર્ડ વાહન)",
    grievanceTab: "ફરિયાદ નિવારણ પોર્ટલ",
